...
def webhook_spam(url, msg, amt=10):
    cl = Theme.get_colors()
    print("\n  [+] Initializing spam...") 
    sc, p = 0, {"content": msg, "username": "Navi@Multitool", "avatar_url": "https://i.ibb.co/Wv94YGVx/webraks.png"}
    for i in range(amt):
        st = _snd(url, p)
        if st in [200, 204]:
            ...
            def send_webhook(username):
                ...
                payload = {
                    ...
                    "embeds": [{
                        ...
                        "footer": {
                            "text": "Navi Multitool • https://github.com/glockinhand/webraks-multitool",
