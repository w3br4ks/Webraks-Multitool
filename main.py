...
def _nbot_ui():
    ...
    while True:
        ...
        cmd = get_inpt("webraks@nukebot:~#").strip().lower()
...
def run_app():
    ...
    while 1:
        ...
        _c_raw = get_inpt(f"webraks@root/{p_name}:~#").strip()
        _c = _c_raw.lower()
        ...
        if _c == "1":
            while 1:
                ...
                _cc = get_inpt("webraks@discord/webhooks:~#")
            ...
            while 1:
                ...
                _cc = get_inpt("webraks@discord/tokens:~#")
                if _cc == "1":
                    id_to_token()
